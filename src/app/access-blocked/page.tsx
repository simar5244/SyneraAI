  ...
  useEffect(() => {
    ...
    if (token) {
      fetch('/api/auth/check-status', {
        ...
        .then(data => {
          setLoading(false);
          // If user is somehow active, redirect to dashboard
    ...
    <div className="min-h-screen bg-gradient-to-r from-red-50 to-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-lg p-10 max-w-2xl w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">Access Blocked</h1>
          ...
          <p className="text-gray-600 text-lg mb-6">
            Your account access has been blocked by an administrator.
          </p>
          ...
          <div className="bg-red-50 border-l-4 border-red-500 p-4 text-red-700 mb-6 text-left">
            <p>
              <span className="font-semibold">What does this mean?</span> Your account access request 
              has been rejected by an administrator, or your account has been deactivated. 
              If you believe this is an error, please contact your organization's administrator.
            </p>
          </div>
          
          <p className="text-gray-600 mb-6">
            For further assistance, please contact your organization's system administrator.
          </p>
        </div>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <Link 
            ...
            className="py-3 px-4 text-center bg-gray-100 hover:bg-gray-200 rounded-md text-gray-700 font-medium transition-colors flex items-center justify-center gap-2"
          >
            <FiMail />
            Contact Support
          </Link>
