...
import { FiXCircle, FiLogOut, FiArrowLeft, FiMail } from 'react-icons/fi';
    ...
    <div className="min-h-screen bg-gradient-to-r from-red-50 to-orange-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-lg p-10 max-w-2xl w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">Account Rejected</h1>
          ...
          <div className="bg-amber-50 border-l-4 border-amber-500 p-4 text-amber-700 mb-6 text-left">
            <p>
              <span className="font-semibold">Why was my account rejected?</span> Your account registration may have been rejected due to 
              verification issues, organizational policies, or other administrative reasons.
            </p>
          </div>
        ...
        <div className="flex flex-col space-y-4">
          {adminEmail && (
            <a
              href={`mailto:${adminEmail}?subject=Account%20Approval%20Request&body=Hello,%0D%0A%0D%0AI'm%20requesting%20approval%20for%20my%20rejected%20account.%0D%0A%0D%0AUsername:%20${user?.username}%0D%0AEmail:%20${user?.email}%0D%0ACompany:%20${user?.company}%0D%0A%0D%0AThank%20you.`}
